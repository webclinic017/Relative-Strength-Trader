...
public class ContractDetails {
    ...
    public String underSymbol() {
        return m_underSymbol;
    }

    public String underSecType() {
        return m_underSecType;
    }

    public String marketRuleIds() {
        return m_marketRuleIds;
    }

    public String realExpirationDate() {
        return m_realExpirationDate;
    }
    ...
    public void secIdList(List<TagValue> secIdList) {
    ...
    public void underSymbol(String underSymbol) {
        m_underSymbol = underSymbol;
    }

    public void underSecType(String underSecType) {
        m_underSecType = underSecType;
    }

    public void marketRuleIds(String marketRuleIds) {
        m_marketRuleIds = marketRuleIds;
    }

    public void realExpirationDate(String realExpirationDate) {
        m_realExpirationDate = realExpirationDate;
    }

    public void lastTradeTime(String lastTradeTime) {
        m_lastTradeTime = lastTradeTime;
    }
