...
public class OrderState {
    ...
    public void initMarginBefore(String v) {
        m_initMarginBefore = v;
    }

    public void maintMarginBefore(String v) {
        m_maintMarginBefore = v;
    }

    public void equityWithLoanBefore(String v) {
        m_equityWithLoanBefore = v;
    }

    public void initMarginChange(String v) {
        m_initMarginChange = v;
    }

    public void maintMarginChange(String v) {
        m_maintMarginChange = v;
    }

    public void equityWithLoanChange(String v) {
        m_equityWithLoanChange = v;
    }

    public void initMarginAfter(String v) {
        m_initMarginAfter = v;
    }

    public void maintMarginAfter(String v) {
        m_maintMarginAfter = v;
    }

    public void equityWithLoanAfter(String v) {
        m_equityWithLoanAfter = v;
    }
