...
public class Order {
    ...
    public String mifid2DecisionMaker() {
        return m_mifid2DecisionMaker;
    }

    public String mifid2DecisionAlgo() {
        return m_mifid2DecisionAlgo;
    }

    public String mifid2ExecutionTrader() {
        return m_mifid2ExecutionTrader;
    }

    public String mifid2ExecutionAlgo() {
        return m_mifid2ExecutionAlgo;
    }

    public boolean dontUseAutoPriceForHedge() {
        return m_dontUseAutoPriceForHedge;
    }
    ...
    public void algoParams(List<TagValue> v) {
        m_algoParams = v;
    }
    ...
    public void orderComboLegs(List<OrderComboLeg> v) {
        m_orderComboLegs = v;
    }
    ...
    public void smartComboRoutingParams(List<TagValue> v) {
        m_smartComboRoutingParams = v;
    }

    public void orderMiscOptions(List<TagValue> v) {
    ...
    public void conditions(List<OrderCondition> v) {
        m_conditions = v;
    }
    ...
    public void cashQty(double v) {
        m_cashQty = v;
    }

    public void mifid2DecisionMaker(String v) {
        m_mifid2DecisionMaker = v;
    }

    public void mifid2DecisionAlgo(String v) {
        m_mifid2DecisionAlgo = v;
    }

    public void mifid2ExecutionTrader(String v) {
        m_mifid2ExecutionTrader = v;
    }

    public void mifid2ExecutionAlgo(String v) {
        m_mifid2ExecutionAlgo = v;
    }

    public void dontUseAutoPriceForHedge(boolean v) {
        m_dontUseAutoPriceForHedge = v;
    }
